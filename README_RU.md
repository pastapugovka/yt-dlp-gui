...
- ⚙️ Настройка параметров загрузки: папка, разрешение, кодек, битрейт, доп. флаги
...
- 🖥️ Встроенная консоль с передачей команд напрямую в yt-dlp
- 🌓 Тёмная/светлая тема и выбор языка (ru/en)
...
- 🖼️ Встраивание обложки/субтитров/метаданных
...
> ⚠️ Примечание: куки хранятся локально без шифрования.
