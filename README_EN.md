...
A detailed step-by-step guide with troubleshooting is in [BUILD.html](BUILD.html) (RU/EN/CN).
...
### Compilation
1. Run `nuget restore` (packages `Microsoft.Windows.CppWinRT` and `Microsoft.WindowsAppSDK`)
2. Open `YtDlpGui.sln`
