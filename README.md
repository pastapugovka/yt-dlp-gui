...
<div align="center">
  <img src="https://skillicons.dev/icons?i=cs" height="64" alt="C# logo"  />
  <img width="12" />
  <img src="https://skillicons.dev/icons?i=cpp" height="64" alt="C++ logo"  />
  <img width="12" />
  <img src="https://skillicons.dev/icons?i=windows" height="64" alt="Windows logo"  />
  <img width="12" />
  <img src="https://skillicons.dev/icons?i=visualstudio" height="64" alt="Visual Studio logo"  />
</div>
...
- ⚙️ Configure download parameters: folder, resolution, codec, bitrate, extra flags
...
- 🖥️ Built-in console to pass commands directly to yt-dlp
- 🌓 Dark/light theme and interface language (ru/en)
...
- 🖼️ Embed thumbnail / subtitles / metadata
...
> ⚠️ Note: cookies are stored locally without encryption.
