...
{
    struct InverseBoolToVisibilityConverter : InverseBoolToVisibilityConverterT<InverseBoolToVisibilityConverter, implementation::InverseBoolToVisibilityConverter>
    {
    };
}
